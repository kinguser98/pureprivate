...
Uint8List rsaFingerprint(RSAPublicKey key) {
  ...
  encoder.writeBytes(bigIntToUnsignedBytes(key.modulus!));
  encoder.writeBytes(bigIntToUnsignedBytes(key.publicExponent!));
  final hash = sha1(encoder.toBytes());
  return hash.sublist(12);
}

List<RSAPublicKey> _buildKeys() {
  return _rsaKeyBytes.map((nBytes) {
