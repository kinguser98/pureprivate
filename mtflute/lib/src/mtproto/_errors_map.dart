// GENERATED FROM gogram errors.go
const Map<String, String> rpcErrorDescriptions = {
  ...
  "AUTH_KEY_DUPLICATED":
      "The authorization key was used under two different IP addresses simultaneously and is now invalid.",
  "AUTH_KEY_INVALID": "The Authorization Key is invalid.",
  "AUTH_KEY_PERM_EMPTY":
      "The method is unavailable for temporary authorization keys, not bound to permanent.",
  ...
  "AUTOARCHIVE_NOT_AVAILABLE":
      "The autoarchive setting is not available at this time; please check the client configuration.",
  ...
  "BOT_METHOD_INVALID":
      "The API access for bot users is restricted. This method cannot be executed as a bot.",
  ...
  "BOT_WEBVIEW_DISABLED":
      "A webview cannot be opened in the specified conditions.",
  "BOTS_TOO_MUCH": "There are too many bots in this chat/channel.",
  "BROADCAST_CALLS_DISABLED":
      "Broadcast calls are disabled for this chat/channel.",
  "BROADCAST_FORBIDDEN":
  ...
  "BUTTON_USER_PRIVACY_RESTRICTED":
      "The privacy setting of the user specified in the button do not allow creating such a button.",
  ...
  "CALL_PROTOCOL_COMPAT_LAYER_INVALID":
      "The other side of the call does not support any of the VoIP protocols supported by the local client.",
  ...
  "CHAT_GUEST_SEND_FORBIDDEN":
      "You must join the discussion group before commenting.",
  ...
  "CHAT_NOT_MODIFIED":
      "No changes were made to chat information because the new information is identical to the current information.",
  ...
  "GRAPH_OUTDATED_RELOAD":
      "The graph is outdated, please get a new async token.",
  "GROUPCALL_ADD_PARTICIPANTS_FAILED":
      "Failed to add participants to the group call.",
  "GROUPCALL_ALREADY_DISCARDED": "The group call was already discarded.",
  "GROUPCALL_ALREADY_STARTED":
      "The groupcall has already started, you can join directly.",
  ...
  "INVITE_FORBIDDEN_WITH_JOINAS":
      "You cannot invite users while anonymously joined as a channel.",
  ...
  "MEDIA_VIDEO_STORY_MISSING":
      "A non-story video cannot be republished as a story.",
  ...
  "MSG_TOO_OLD":
      "Time has passed since the message was sent, read receipts were deleted.",
  "MSG_WAIT_FAILED": "A waiting call returned an error.",
  "MT_SEND_QUEUE_TOO_LONG":
      "The message was not sent because the send queue is too long.",
  ...
  "PARTICIPANT_JOIN_MISSING":
      "User must join the Video Chat before enabling presentation.",
  ...
  "PERSISTENT_TIMESTAMP_OUTDATED":
      "Channel internal replication issues, try again later.",
  ...
  "POSTPONED_TIMEOUT":
      "An internal timeout occurred with the Telegram server, try again later.",
  ...
  "REACTIONS_TOO_MANY":
      "The message already has too many reaction emojis, you can't react with a new emoji.",
  ...
  "SESSION_REVOKED":
      "The authorization has been invalidated because the user terminated all sessions.",
  ...
  "STORIES_TOO_MUCH":
      "You have hit the maximum active stories limit; you should buy a Premium subscription or wait for the oldest story to expire.",
  ...
  "UPDATE_APP_TO_LOGIN":
      "This layer no longer supports logging in, please update your app.",
  ...
  "FLOOD_PREMIUM_WAIT_X":
      "A wait of %v seconds is required before calling the method.",
  "FLOOD_TEST_PHONE_WAIT_X":
      "A wait of %v seconds is required in the test servers.",
  ...
  "PASSWORD_TOO_FRESH_X":
      "The password was modified less than 24 hours ago, try again in %v seconds.",
  "PHONE_MIGRATE_X":
      "The phone number a user is trying to use for authorization is associated with DC %v.",
  ...
  "SLOWMODE_WAIT_X":
      "Slowmode is enabled in this chat: wait %v seconds before sending another message to this chat.",
  ...
  "TAKEOUT_INIT_DELAY_X":
      "Sorry, for security reasons, you will be able to begin downloading your data in %v seconds.",
  "USER_MIGRATE_X":
