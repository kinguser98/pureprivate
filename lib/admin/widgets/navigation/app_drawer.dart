            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  _divider(),
                  _sectionHeader('Web & Cloud Tools'),
                  _navItem(context, ref, Icons.public_rounded, 'Power Browser', '/browser', currentRoute == '/browser', color: const Color(0xFF38BDF8)),
                  _navItem(context, ref, Icons.download_rounded, 'Download Manager', '/downloads', currentRoute == '/downloads', color: const Color(0xFF10B981)),
